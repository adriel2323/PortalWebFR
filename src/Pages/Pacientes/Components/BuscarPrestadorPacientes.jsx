...
import Icon from "../../../componentes/BotonesHome/IconXs";
import { faArrowAltCircleLeft } from "@fortawesome/free-solid-svg-icons";
import { useContext, useState } from "react";
import {CartillaContext} from "./BuscarCartillaPacientes";
import Opciones from "../../../componentes/ObraSocial/Cartilla/Opciones";
    ...
    return(
        <>
            <section>
                ...
                <div className=" cursor-pointer flex mt-3" onClick={volverABuscador}>
                    <Icon icono={faArrowAltCircleLeft}/>
                    <h1 className=" cursor-pointer ml-3 self-center">
                        Volver
                    </h1>
                </div>
            </section>
